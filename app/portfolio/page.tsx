...
export default function PortfolioPage() {
  ...
  return (
    <>
      ...
      <section className="relative bg-brand-teal text-white py-24 overflow-hidden" style={{ minHeight: "50vh" }}>
        ...
        {/* Content covering entire pattern background */}
        <div className="flex flex-col items-center justify-center h-full mt-20 container mx-auto px-4 relative z-10 text-center">
          ...
          {/* Visual counter stats - Just fixing spacing */}
          <div className="flex flex-col items-center space-y-8 w-full max-w-3xl mx-auto mt-6">
            <div>
              <div className="text-5xl md:text-6xl font-bold font-serif text-white text-center">4</div>
              <div className="text-sm text-white/90 mt-1 font-medium text-center">Properties</div>
            </div>
            
            <div>
              <div className="text-5xl md:text-6xl font-bold font-serif text-white text-center">95%</div>
              <div className="text-sm text-white/90 mt-1 font-medium text-center">Occupancy Rate</div>
            </div>
            
            <div>
              <div className="text-5xl md:text-6xl font-bold font-serif text-white text-center">€2.5M+</div>
              <div className="text-sm text-white/90 mt-1 font-medium text-center">Property Value</div>
            </div>
