          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="space-y-8">
              ...
              >
                <h2 className="text-3xl font-bold text-permafrost mb-4 font-serif">
                  {t("services.investment.features.title")}
                </h2>
                <ul className="space-y-4">
                  {[
                    "services.investment.features.1",
                    "services.investment.features.2",
                    "services.investment.features.3"
                  ].map((feature, index) => (
            ...
            >
              <div className="aspect-w-16 aspect-h-9 bg-limestone/5 rounded-lg overflow-hidden">
                {/* Add your investment image here */}
              </div>
            </motion.div>
          </div>
        </div>
