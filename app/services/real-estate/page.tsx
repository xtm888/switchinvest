          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="space-y-8">
              ...
              >
                <p className="text-xl text-permafrost/80 font-serif tracking-tight">
                  {t("services.real_estate.description")}
                </p>
              </motion.div>
              ...
              >
                <h2 className="text-3xl font-bold text-permafrost mb-4 font-serif">
                  {t("services.real_estate.features.title")}
                </h2>
                <ul className="space-y-4">
                  {[
                    "services.real_estate.features.1",
                    "services.real_estate.features.2",
                    "services.real_estate.features.3"
                  ].map((feature, index) => (
            ...
            >
              <div className="aspect-w-16 aspect-h-9 bg-limestone/5 rounded-lg overflow-hidden">
                {/* Add your real estate image here */}
              </div>
            </motion.div>
          </div>
        </div>
