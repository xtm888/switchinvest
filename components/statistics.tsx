...
export function Statistics() {
  ...
  // Calculate the total square meters from the portfolio items
  // Étoile Residences: 6,000 m²
  // Portside Business Centre: 15,500 m²
  // North Sea Gateway Logistics: 42,000 m²
  // The Sablon Quarters: 9,500 m²
  const totalSqMeters = 6000 + 15500 + 42000 + 9500
  
  const statistics: Statistic[] = [
    { key: "propertiesManaged", prefix: "", value: "4", suffix: " properties" },
    { key: "totalSquareMeters", prefix: "", value: "73,000", suffix: " m²" },
  ...
  return (
    <motion.div
      ...
      className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 py-12"
    >
      {statistics.map((stat) => (
        <motion.div
          key={stat.key}
