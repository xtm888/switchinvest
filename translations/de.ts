...
export const de: Translation = {
  valuation: {
    title: "Verkaufen Sie Ihre Immobilie An Uns - Barangebot",
    address: "Adresse",
  ...
  home: {
    trustBadge: "Über 500 Immobilien Direkt Gekauft",
    ctaPrimary: "Verkaufen Sie Ihre Immobilie An Uns",
    ctaSecondary: "Sehen Sie Wie Wir Kaufen",
    featuresTitle: "Warum Direkt An SwitchInvest Verkaufen?",
    featuresSubtitle: "Wir kaufen schnell - keine Makler, kein Warten, kein Ärger",
    features: {
      fastOffers: {
        title: "Wir Kaufen in 24-48h",
        description: "Erhalten Sie unser Barangebot in 2 Tagen - wir sind der Käufer"
      },
      noFees: {
        title: "Wir Zahlen Direkt An Sie",
        description: "Keine Maklerprovisionen - wir kaufen direkt von Ihnen"
      },
      asIs: {
        title: "Wir Kaufen WIE BESEHEN",
        description: "Wir kaufen Ihre Immobilie in jedem Zustand"
      },
      quickClosing: {
        title: "Schnelle Barzahlung",
        description: "Abschluss und Zahlung in 7 Tagen"
      }
    },
    mapTitle: "Unsere Präsenz in Ganz Belgien",
    mapSubtitle: "Immobilienbesitzer in allen Regionen mit lokaler Expertise bedienen",
    hero: {
      badge: "500+ Immobilien Direkt Gekauft - Wir Sind Der Käufer",
      title: "Wir Kaufen Ihre Immobilie",
      titleHighlight: "Barangebot in 24-48 Stunden",
      subtitle: "Verkaufen Sie direkt an uns - Keine Makler, kein Warten auf Käufer, kein Ärger.",
      features: "Wir kaufen WIE BESEHEN • Null Provision • Barzahlung",
      ctaPrimary: "Holen Sie Sich Ihr Barangebot",
      ctaSecondary: "Sehen Sie Wie Es Funktioniert",
      trustIndicators: [
        "24-48h Barangebot Garantiert",
        "Wir Sind Der Käufer - Kein Warten",
        "Wir Kaufen WIE BESEHEN"
      ],
      ...
      items: [
        {
          value: 500,
          suffix: "+",
          label: "Immobilien Die Wir Gekauft Haben",
          description: "Direkt von belgischen Immobilienbesitzern"
        },
        {
          value: 24,
          suffix: "h",
          label: "Barangebot Geschwindigkeit",
          description: "Transparentes Kaufangebot in 24-48 Stunden"
        },
        {
          value: 98,
          suffix: "%",
          label: "Zufriedenheitsrate",
          description: "Der Verkäufer empfehlen uns zu verkaufen"
        },
        {
          value: 0,
          suffix: "€",
          label: "Versteckte Kosten",
          description: "Wir zahlen direkt an Sie - keine Provisionen"
        }
      ],
      ctaText: "Treten Sie 500+ Eigentümern bei, die direkt an uns verkauft haben",
      ctaButton: "Jetzt An Uns Verkaufen"
    },
    testimonials: {
      title: "Was Eigentümer Sagen, Die An Uns Verkauft Haben",
      subtitle: "Echte Geschichten von Eigentümern, die direkt an SwitchInvest verkauft haben",
      pressTitle: "Gesehen in den Medien",
      items: [
        {
          name: "Marie Dubois",
          location: "Brüssel",
          role: "Hat an SwitchInvest verkauft",
          quote: "Ich habe meine Immobilie direkt an SwitchInvest verkauft. Sie machten mir ein faires Angebot in 24 Stunden und ich erhielt meine Zahlung in weniger als zwei Wochen. Es war so viel einfacher als über einen Makler!",
          rating: 5,
        ...
        },
        {
          ...
          location: "Antwerpen",
          role: "Hat an SwitchInvest verkauft",
          quote: "Ich musste schnell verkaufen und SwitchInvest kaufte mein Haus im Ist-Zustand. Keine Reparaturen, kein Warten auf Käufer, kein Stress. Sie sind der Käufer - kein Makler.",
          rating: 5,
        ...
        },
        {
          ...
          location: "Lüttich",
          role: "Hat an SwitchInvest verkauft",
          quote: "Ich hatte eine Immobilie geerbt, die große Reparaturen benötigte. SwitchInvest kaufte sie direkt im Ist-Zustand zu einem fairen Preis. Einfacher und schneller Prozess von Anfang bis Ende.",
          rating: 5,
        ...
        },
        {
          ...
          location: "Gent",
          role: "Hat an SwitchInvest verkauft",
          quote: "Ich habe ihnen meine Immobilie direkt verkauft, um mein Geschäft zu finanzieren. Barangebot in 48h, Abschluss in 10 Tagen. Der Service war professionell, transparent und stressfrei!",
          rating: 5,
    ...
    faq: {
      ...
      subtitle: "Sie haben Fragen zum Verkauf Ihrer Immobilie direkt an SwitchInvest? Finden Sie hier die Antworten.",
      stillHaveQuestions: "Können Sie die Antwort auf Ihre Frage nicht finden?",
      contactButton: "Sprechen Sie Mit Einem Käufer"
    },
    newsletter: {
  ...
  navigation: {
    ...
    portfolio: "Immobilien Die Wir Gekauft Haben",
    technologies: "Technologien",
    about: "Über Uns",
    clientPortal: "Verkaufen Sie An Uns",
    contactUs: "Holen Sie Sich Barangebot",
  },

  // 2. Hero-Bereich
  hero: {
    title: "Wir Kaufen Ihre Immobilie - Schnelles Barangebot",
    tagline: "Verkaufen Sie Direkt An Uns - Keine Makler, Kein Warten Auf Käufer!",
    subtitle: "SwitchInvest kauft Immobilien direkt von belgischen Eigentümern. Wir sind der Käufer - keine Agentur, die Ihre Immobilie zum Verkauf anbietet. Erhalten Sie ein transparentes Barangebot in 24-48h, schließen Sie nach Ihrem Zeitplan ab und erhalten Sie die Zahlung direkt. Ob Sie eine Immobilie geerbt haben, ein Haus besitzen, das Reparaturen benötigt, oder schnell verkaufen möchten, wir kaufen WIE BESEHEN ohne Provisionen. Kein Warten auf andere Käufer, keine Besichtigungen, kein Ärger."
  },
  ...
  // 5. Dienstleistungen
  services: {
    title: "Wie Wir Immobilien Kaufen & Zusätzliche Dienstleistungen",
    subtitle: "Wir kaufen Immobilien direkt - plus Renovierungs- und Investitionsdienstleistungen",
    learnMore: "Mehr erfahren",
    real_estate: {
      title: "Wir Kaufen Ihre Immobilie (Hauptservice)",
      description: "Verkaufen Sie direkt an uns - erhalten Sie unser Barangebot in 24–48h und schließen Sie in 7 Tagen ab. Wir sind der Käufer, keine Agentur.",
      features: [
  ...
  process: {
    title: "Wie Wir Ihre Immobilie Kaufen",
    steps: [
      { title: "Schritt 1: Reichen Sie Ihre Immobilie Ein", description: "Füllen Sie unser kurzes Online-Formular aus oder rufen Sie uns an mit Immobiliendetails: Adresse, Typ, Größe und Zustand. Wir kaufen WIE BESEHEN." },
      { title: "Schritt 2: Erhalten Sie Unser Barangebot", description: "Erhalten Sie in 24-48h unser transparentes Kaufangebot, basierend auf echten Marktdaten. Wir sind der Käufer - keine Agentur." },
      { title: "Schritt 3: Akzeptieren & Abschluss Planen", description: "Wählen Sie Ihr Abschlussdatum (7-30 Tage). Wir übernehmen alle rechtlichen Formalitäten und zahlen Notarkosten. Sie verkaufen direkt an uns." },
      { title: "Schritt 4: Erhalten Sie Ihre Zahlung", description: "Unterschreiben, übertragen Sie die Immobilie, und erhalten Sie Ihre volle Barzahlung. Wir übernehmen dann alle Renovierungen mit unserem eigenen Kapital." }
    ]
  },

  why_choose_us: {
    title: "Warum Direkt An SwitchInvest Verkaufen?",
    items: [
      { title: "Wir Sind Der Käufer", description: "Keine Agentur - wir kaufen Ihre Immobilie direkt mit unserem eigenen Kapital. Kein Warten auf andere Käufer." },
      { title: "Barangebot in 24-48h", description: "Erhalten Sie unser transparentes Kaufangebot in 2 Tagen - vom Angebot zur Zahlung in nur 7 Tagen." },
      { title: "Wir Kaufen WIE BESEHEN", description: "Null Reparaturen erforderlich, keine Inszenierung, keine mehrfachen Besichtigungen. Wir kaufen Ihre Immobilie so wie sie ist." },
      { title: "Null Gebühren & Provisionen", description: "Keine Maklerprovisionen, keine versteckten Kosten. Sie erhalten unser volles Angebot - wir zahlen alle Gebühren." },
      { title: "Vertrauenswürdiger Lokaler Käufer", description: "Über 500 Immobilien in Belgien seit 2010 gekauft. Tiefe Marktkenntnisse für faire Angebote." }
    ]
  },

  audience: {
    title: "Wer Direkt An Uns Verkauft",
    items: [
      { title: "Rentner Die Verkleinern", description: "Verkaufen Sie uns Ihr Familienhaus schnell, um Kapital für den Ruhestand freizusetzen - ohne monatelanges Warten auf einen Käufer." },
      { title: "Immobilienerben", description: "Sie haben eine Immobilie aus der Ferne geerbt oder wollen sie nicht verwalten? Verkaufen Sie sie direkt an uns - schnelle Umwandlung in Bargeld." },
      { title: "Besitzer Problematischer Immobilien", description: "Ihre Immobilie benötigt große Reparaturen? Wir kaufen sie WIE BESEHEN - Sie zahlen keine teuren Renovierungskosten." },
      { title: "Schnelle Lebensübergänge", description: "Brauchen Sie schnell Kapital für ein Geschäft, Scheidung, Umzug? Verkaufen Sie direkt an uns und erhalten Sie Zahlung in 7-30 Tagen." }
    ]
  },

  concerns: {
    title: "Häufige Bedenken Ansprechen",
    items: [
      { myth: "\"Direktkäufer bieten zu niedrige Preise.\"", reality: "Unsere Angebote spiegeln den echten Marktwert minus Renovierungskosten wider, die WIR zahlen (nicht Sie). Vergleichen Sie mit einem Agenturverkauf nach Provisionen und Reparaturen - unser Angebot ist oft besser." },
      { myth: "\"Direkt an einen Käufer zu verkaufen ist riskant.\"", reality: "SwitchInvest kauft seit 2010 Immobilien in Belgien mit über 500 erfolgreichen Transaktionen. Wir sind ein lizenzierter und regulierter Käufer - kein Betrug." },
      { myth: "\"Ich sollte auf einen besseren Preis von einer Agentur warten.\"", reality: "Agenturverkäufe dauern 3-6 Monate, erfordern Reparaturen, Provisionen (6-8%) und Besichtigungen. Wir kaufen WIE BESEHEN in 7-30 Tagen ohne Gebühren. Rechnen Sie nach." }
    ]
  },

  testimonials: [
    { client: "Marie, 68 (Hat an SwitchInvest verkauft)", quote: "Nach dem Tod meines Mannes verkaufte ich unser Haus direkt an SwitchInvest. Sie machten mir ein faires Angebot in 24 Stunden und übernahmen alles. Zwei Wochen später war ich auf dem Weg nach Italien mit meiner Zahlung!" },
    { client: "Luc & Anouk (Haben an SwitchInvest verkauft)", quote: "Wir erbten ein verfallenes Haus von meinem Onkel aus der Ferne. SwitchInvest kaufte es direkt wie besehen - null Stress, null Reparaturen. Jetzt finanziert das Geld das Studium unserer Tochter!" },
    { client: "Ahmed (Hat an SwitchInvest verkauft)", quote: "Ich verkaufte meine Wohnung in Brüssel direkt an SwitchInvest, um mein Startup zu finanzieren. Angebot in 48h, Zahlung in 10 Tagen. Keine Makler, kein Warten - nur schnelles Bargeld!" }
  ],

  renovation_transparency: {
    title: "Was Passiert Mit Ihrer Immobilie Nachdem Wir Sie Kaufen?",
    renovationScope: [
      "Wir investieren unser eigenes Kapital in vollständige strukturelle Reparaturen (Dach, Fundament, Sanitär, Elektrik).",
      "Wir modernisieren mit neuen Küchen, Badezimmern, Böden und Einrichtungen.",
      "Wir fügen umweltfreundliche Verbesserungen hinzu (Isolierung, Solarpanels, effiziente Heizung) für zukünftige Familien."
    ],
    communityImpact: "Durch den direkten Kauf von notleidenden Immobilien revitalisieren wir belgische Viertel, indem wir vernachlässigte Immobilien in schöne, moderne Häuser für neue Familien umwandeln - Wert für Gemeinschaften schaffen."
  },

  faqs: [
    { question: "Sind Sie eine Immobilienagentur oder ein Makler?", answer: "Nein! Wir sind KEINE Agentur. SwitchInvest ist ein Immobilienkäufer - wir kaufen Immobilien direkt mit unserem eigenen Kapital. Sie verkaufen AN uns, nicht DURCH uns. Kein Warten auf andere Käufer, keine Auflistung, keine Maklerprovisionen." },
    { question: "Erheben Sie Gebühren oder Provisionen?", answer: "Null Gebühren. Unser Barangebot ist der volle Betrag, den Sie erhalten - keine Maklerprovisionen (sparen Sie 6-8%), keine Abschlusskosten, keine versteckten Gebühren. Wir zahlen sogar die Notarkosten." },
    { question: "Was passiert, wenn mein Haus schwere Schäden, Schimmel oder Reparaturen benötigt?", answer: "Perfekt! Wir kaufen Immobilien WIE BESEHEN. Undichtes Dach? Rissiges Fundament? Wasserschaden? Veraltete Sanitäranlagen? Wir kaufen so wie es ist - Sie zahlen KEINE Reparaturen." },
    { question: "Kann ich einen Teil meiner Immobilie oder Miteigentum verkaufen?", answer: "Ja! Wir kaufen Land, Miteigentumsanteile, gemeinsam vererbte Immobilien und sogar Immobilien mit komplexen rechtlichen Situationen." },
    { question: "Wie kann ich wissen, dass Ihr Angebot fair ist?", answer: "Wir liefern eine transparente Aufschlüsselung: Marktwert - Renovierungskosten die WIR zahlen werden - unsere angemessene Marge = Ihr Angebot. Vergleichen Sie es mit einem Agenturverkauf nach Provisionen und Reparaturen!" }
  ],

  cta: {
    title: "Bereit Ihre Immobilie Direkt An Uns Zu Verkaufen? Holen Sie Sich Jetzt Ihr Kostenloses Barangebot!",
  ...
  // 6. Portfolio
  portfolio: {
    title: "Immobilien Die Wir Gekauft & Renoviert Haben",
    subtitle: "Echte Beispiele von Immobilien, die wir direkt gekauft und transformiert haben",
    explore: "Sehen Sie Unsere Vergangenen Käufe",
  ...
  about: {
    title: "Über uns",
    heroSubtitle: "Belgiens Führendes Immobilienankaufsunternehmen Seit 2010",
    description: "Seit 2010 kauft SwitchInvest Immobilien direkt von belgischen Eigentümern, die schnell verkaufen müssen. Wir sind der Käufer - keine Agentur. Wir kaufen Immobilien WIE BESEHEN mit transparenten Barangeboten in 24–48h, dann investieren wir unser eigenes Kapital in Renovierungen und Entwicklung. Über 500 Eigentümer haben direkt an uns in ganz Belgien verkauft.",
    storyTitle: "Unsere Geschichte",
    mission: "Belgischen Immobilieneigentümern die schnellste und transparenteste Möglichkeit zu bieten, ihre Immobilien zu verkaufen, indem wir sie direkt mit fairen Barangeboten kaufen.",
    missionTitle: "Mission",
    vision: "Belgiens vertrauenswürdigster Direktkäufer von Immobilien zu werden, anerkannt für unsere fairen Angebote, schnellen Abschlüsse und Hilfe für Eigentümer beim Erreichen ihrer finanziellen Ziele.",
    visionTitle: "Vision",
    values: {
      title: "Unsere Werte",
      items: [
  ...
  // Kontaktseite
  contact: {
    title: "Verkaufen Sie Ihre Immobilie An SwitchInvest",
    subtitle: "Holen Sie sich Ihr kostenloses Barangebot in 24-48h. Wir kaufen Immobilien direkt in ganz Belgien.",
