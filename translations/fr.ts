...
export const fr: Translation = {
  ...
  navigation: {
    ...
    about: "À Propos",
    clientPortal: "Nous Contacter", // Updated for backward compatibility
    contactUs: "Nous Contacter",
  },
  hero: {
    title: "Élever l'Immobilier Belge à des Standards d'Exception",
    tagline: "Expertise Inégalée en Gestion Immobilière Premium",
    subtitle: "Chez SwitchInvest, nous vous déchargeons de toute préoccupation opérationnelle – guidant, protégeant et renforçant subtilement vos ambitions immobilières avec des solutions sur mesure.",
  },
  statistics: {
  ...
  services: {
    title: "Nos Services",
    subtitle: "Solutions Complètes pour Vos Besoins Immobiliers",
    learnMore: "En savoir plus",
    real_estate: {
      title: "Gestion Immobilière Premium",
      description: "Administration de bout en bout d'actifs de grande valeur, avec une attention inébranlable aux détails et à la conformité.",
      features: [
        "Gestion immobilière complète",
        "Conformité légale & surveillance réglementaire",
    ...
    investment: {
      ...
      description: "Conseils sophistiqués pour faire croître et protéger votre capital sur les marchés belges.",
      features: [
        "Analyse de marché approfondie",
        "Gestion ciblée des risques",
        "Optimisation de la performance du portefeuille",
        "Rendements maximisés à long terme"
      ]
    },
    development: {
      title: "Excellence en Développement Immobilier",
      description: "De la vision à la livraison, nous pilotons les projets avec précision et valorisation à chaque étape.",
      features: [
        "Gestion de projet de bout en bout",
        "Supervision de la construction et du chantier",
        "Examens d'ingénierie de la valeur",
        "Contrôle qualité rigoureux"
      ]
    },
    management: {
      title: "Administration Immobilière Professionnelle",
      description: "Gérance holistique des actifs qui préserve et améliore votre patrimoine immobilier.",
      features: [
  ...
  about: {
    ...
    description: "Fondée en 2010, SwitchInvest.be est née de la volonté de réinventer la gestion immobilière belge en alliant expertise éprouvée et innovation sur mesure. Nous assurons une prise en charge globale qui maximise la valeur des actifs tout en garantissant une expérience fluide et discrète pour nos investisseurs exigeants.",
  ...
  cta: {
    title: "Prêt à Transformer Votre Portefeuille Immobilier ?",
    tagline: "Créons Quelque Chose d'Extraordinaire Ensemble",
    subtitle: "Découvrez l'avenir de la gestion immobilière avec nos solutions de pointe et notre approche personnalisée.",
    consultation: "Planifier une Consultation",
    explore: "Explorer les Services →",
    description: "Contactez-nous pour discuter de la manière dont nous pouvons vous aider à atteindre vos objectifs immobiliers.",
